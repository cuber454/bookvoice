 ...
 *
 *  [autoTitle] — название придумали МЫ, а не книга (у PDF без закладок глава на
 *  каждую страницу называется «Стр. N», 0.4.71). В оглавлении такое название
 *  нужно — по нему переходят к странице, — а вслух его не читают: слушать
 *  «Стр. 1, Стр. 2…» на каждой странице нечего. */
data class Chapter(
    val title: String?,
