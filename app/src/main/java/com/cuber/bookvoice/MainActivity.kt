...
class MainActivity : AppCompatActivity(), ReaderEngine.Host {
    ...
    companion object {
        ...
        // #85 (msg5895/5899/5919): останавливать чтение, когда зажигается экран
        // или его разблокируют. Три состояния — как у строк таймера сна (msg5919):
        // выключено / при включении экрана / при разблокировке. Default ВЫКЛ —
        // поведение менялось бы у всех, кто уже привык к чтению под погашенным
        // экраном. Кнопки Power как таковой приложению не видно (Android 9+),
        // поэтому «при включении экрана» — это ACTION_SCREEN_ON, а он приходит
        // и от вспышки на уведомление; кому это мешает — берёт «разблокировку».
        internal const val KEY_PAUSE_ON_SCREEN = "pause_when_screen"

        /** Не останавливать чтение — по умолчанию. */
        internal const val PAUSE_SCREEN_OFF = 0

        /** Останавливать, когда экран зажёгся (ACTION_SCREEN_ON). */
        internal const val PAUSE_SCREEN_ON = 1
