...
internal object SleepTimerPrefs {
    ...
    /** Во сколько продлевать — три ступени, третьей «навсегда» нет намеренно:
     *  случайная встряска во сне не должна снимать таймер до утра (msg4941). */
    val EXTEND_CHOICES = intArrayOf(5, 10, 15)
    ...
    /** Продление в минутах. Значение из prefs может быть любым (старая сборка,
     *  правка файла руками) — вне шкалы берём умолчание. */
