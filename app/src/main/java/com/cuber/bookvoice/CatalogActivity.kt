...
class CatalogActivity(private val act: SectionActivity) {
     ...
     *  «куча всего говорит».
     *
     *  Теперь: микрофон наш, окно никуда не уходит — перечитывать после возврата
     *  нечего, подсказку никто не читает. О готовности сообщает сам
     *  распознаватель: свой [SoundFx.listen] убран (msg6404), иначе звучало два
