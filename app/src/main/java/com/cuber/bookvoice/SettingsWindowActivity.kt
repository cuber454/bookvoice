...
class SettingsWindowActivity : SectionActivity() {
    ...
    override fun onDestroy() {
        super.onDestroy()
        // msg5640: плеер образца фразы («Прослушать» без книги) гасим на выходе
        // из Настроек. Временный движок для списков гасит сам набор (VoicePicker),
        // когда список закрыт, — за него тут не отвечаем.
        settings.shutdownSample()
